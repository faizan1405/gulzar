      ...
      {successMsg ? (
        <div style={{
          ...
          <div style={{ marginTop: '20px' }}>
            <a
              href={`https://wa.me/919557006617?text=${encodeURIComponent(`Assalamu Alaikum, I have submitted an inquiry on Shadi Mubarak. Name: ${fullName}, Phone: ${phone}, Type: ${inquiryType}. Please guide me.`)}`}
              target="_blank"
