        ...
        <div className="container font-sans" style={{ padding: '40px 0 80px 0' }}>
          ...
          <div style={{
            ...
            <div className="card-theme-wrapper" style={{ padding: '24px', position: 'sticky', top: '100px' }}>
              ...
              {!simulatedPackages.includes('good_profile_package') && (
                <>
                  <button
                  ...
                  <a
                    href={`https://wa.me/919675483125?text=${encodeURIComponent("Assalamu Alaikum, I am interested in the ₹5,500 Good Profiles Package on Shadi Mubarak. Please guide me.")}`}
                    target="_blank"
